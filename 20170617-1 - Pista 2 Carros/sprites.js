...
trackImage.src = "Assets/track/pista2.png"; // Define ficheiro fonte para a Imagem

function drawTrack() {
    contextPista.drawImage( // Desenhar frame da sprite sheet
...
// Car
var carImageBlue = new Image(); // Cria nova Imagem
carImageBlue.src = "Assets/car/Car - Blue.png"; // Define ficheiro fonte para a Imagem

var carImageRed = new Image(); // Cria nova Imagem
carImageRed.src = "Assets/car/Car - Red.png"; // Define ficheiro fonte para a Imagem

var carImageYellow = new Image(); // Cria nova Imagem
carImageYellow.src = "Assets/car/Car - Yellow.png"; // Define ficheiro fonte para a Imagem

var carImageGreen = new Image(); // Cria nova Imagem
carImageGreen.src = "Assets/car/Car - Green.png"; // Define ficheiro fonte para a Imagem


function drawCar(x,y,w,h,color) {
    var selectedCarImage = eval('carImage' + color); 
    context.drawImage( // Desenhar frame da sprite sheet
        selectedCarImage, // Imagem da sprites sheet toda
        0, 0, // Coordenadas do canto sup esquerdo da frame a recortar da imagem
        selectedCarImage.width, selectedCarImage.height, // Largura e Altura da frame a recortar
