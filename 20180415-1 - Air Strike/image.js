...
const imageAirplane = new Image();   // Create new img element
imageAirplane.onload = function () {console.log("Airplane loaded!")}
imageAirplane.src = "Assets/planes/Luftwaffe.png"; // Set source path
