...
var utils = {
    ...
    getRandomColorRGB:function () {             // Funcao geradora de cores aleatorias em RGB
        ...
        var rgb_g = Math.floor(factor * 255);
        var rgb_b = Math.floor(factor * 255);
    ...
    getRandomYellowColorRGB:function () {             // Funcao geradora de cores aleatorias em RGB
        var factor = Math.random();
        var rgb_r = Math.floor(factor * 1/5*255 +4/5*255);
        var rgb_g = Math.floor(factor * 1/5*255 +4/5*255);
        var rgb_b = Math.floor(factor * 1/5*255);
        var color = 'rgb(' + rgb_r + ',' + rgb_g + ',' + rgb_b + ')';
        return color;
    },
