...
/*  PROXIMOS DESENVOLVIMENTOS
    ...
    - Add animação de destruição/explosão dos Asteroides
    - Add Planeta(s) ou Estrela(s) ou Black Hole(s) com Gravidade (atrai Nave e Asteroids)
    ...
    - Vários Níveis em que se mantém Game Engine mas pioram parâmetros
        ...
        - Add Planeta(s) ou Estrela (s) com Gravidade (atrai nave e Asteroids)
