...
var utils = {
    ...
    getRandomColorRGB:function (r,g,b) {             // Funcao geradora de cores aleatorias em RGB
    rgb_r = r*Math.floor(Math.random() * 255);
    rgb_g = g*Math.floor(Math.random() * 255);
    rgb_b = b*Math.floor(Math.random() * 255);
